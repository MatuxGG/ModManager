    ...
    public static class ModWorker
    {
        ...
        public static async Task removeLoggingConsole()
        {
            ...
            else
            {
                ...
                {
                    Directory.CreateDirectory(ConfigManager.config.dataPath + @"\mod");
                }
                if (!Directory.Exists(ConfigManager.config.dataPath + @"\mod\BepInEx"))
                {
                    Directory.CreateDirectory(ConfigManager.config.dataPath + @"\mod\BepInEx");
                }
                if (!Directory.Exists(ConfigManager.config.dataPath + @"\mod\BepInEx\config"))
                {
                    Directory.CreateDirectory(ConfigManager.config.dataPath + @"\mod\BepInEx\config");
                }
