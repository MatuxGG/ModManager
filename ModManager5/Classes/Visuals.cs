...
namespace ModManager5.Classes
{
    public static class Visuals
    {
        ...
        {
            TableLayoutPanel LayoutPanel = Visuals.createLayoutPanelH(0, 100, DockStyle.Top, new int[] { 20, 60, 20 });
        ...
        public static void ServerLine(TableLayoutPanel panel, int y, Server server, TextBox ServerName, TextBox ServerIP, TextBox ServerPort, PictureBox ServerValidPic, PictureBox ServerRemovePic, Boolean official, Boolean last)
        {
            ...
            ServerValidPic.Image = global::ModManager5.Properties.Resources.valid;
        ...
        public static void TranslationLine(TableLayoutPanel panel, int y, Translation t, Label ori, TextBox tr, PictureBox valid)
        {
            ...
            valid.Image = global::ModManager5.Properties.Resources.valid;
        ...
        public static TableLayoutPanel LocalModsOverlay()
        {
            TableLayoutPanel panel = new TableLayoutPanel();
            panel.Dock = DockStyle.Top;
            panel.BackColor = ThemeList.theme.AppOverlayColor;
            ...
            System.Windows.Forms.Label ModTitlePath = new System.Windows.Forms.Label();
            ModTitlePath.Font = new System.Drawing.Font(ThemeList.theme.XLFont, ThemeList.theme.XLSize, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ModTitlePath.BackColor = Color.Transparent;
            ModTitlePath.ForeColor = SystemColors.Control;
            ModTitlePath.TextAlign = ContentAlignment.MiddleLeft;
            ModTitlePath.Dock = DockStyle.Left;
            ModTitlePath.Name = "ModTitlePath";
            ...
            ModTitleGameVersion.Size = new System.Drawing.Size(250, 50);
            ModTitleGameVersion.Text = Translator.get("Game Version");
            panel.Controls.Add(ModTitleGameVersion, 1, 0);
